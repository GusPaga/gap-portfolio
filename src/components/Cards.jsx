export const Cards = () => {
  return (
    <div id="cards" className="mx-auto my-5">
      <div className="container-fluid">
        ...
        <div className="row mx-auto mt-5">
          ...
          <div className="col-12 col-md-6 col-lg-4  cardsAnimation">
            <div className="card p-3 mb-5 bg-body rounded">
              <img
                src="https://i.ibb.co/TKpPtDW/bootstrap1.png"
                className="card-img-top"
                alt="Virtual Cv"
              />
              <div className="card-body">
                ...
                <p>
                  ...
                  encontraras más imágenes de este proyecto.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-md-6 col-lg-4  cardsAnimation">
            <div className="card p-3 mb-5 bg-body rounded">
              <img
                src="https://i.ibb.co/CQ85zZT/cv-portada.png"
                className="card-img-top"
                alt="C&B"
              />
              <div className="card-body">
                ...
                <p className="card-text mt-4">
                  En este proyecto despliego distintan nueva herramientas,
                  <b> "Imgbb"</b>, para el manejo de imágenes, distintos
                  componentes de <b>"Bootstrap"</b>, como carousel, modals,
                  badges, navbar, cards, además de multiples estilos
                </p>
                <p>
                  Si quieres conocer este sitio has click{" "}
                  <a
                    href="http://gap-portfolio.vercel.app"
                    target="_blank"
                    rel="noreferrer"
                  >
                    aquí
      ...
      {/* MODAL BOOTSTRAP */}
      <div className="modal" id="modalBootstrap" tabindex="-1">
        <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">"Bootstrap"</h5>
              <button
                type="button"
                className="btn-close"
                data-bs-dismiss="modal"
            ...
            <div className="modal-body">
              <div className="row mx-auto">
                <div className="col col-md-6 col-lg-6">
                  ...
                  />
                  <img
                    src="https://i.ibb.co/wBX6TCD/bootstrap2.png"
                    className="w-100 mb-4 rounded"
                    alt="Oradores"
                  />
                </div>
                <div className="col col-md-6 col-lg-6">
                  <img
                    src="https://i.ibb.co/rcDQp1t/bootstrap3.png"
                    className="w-100 mb-4 rounded"
                    alt="Formulario"
                  />
                </div>
      ...
      {/* MODAL BOOTSTRAP */}
      {/* MODAL CV */}
      <div className="modal" id="modalVirtualCv" tabindex="-1">
        <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">"Virtual Cv"</h5>
              <button
                type="button"
                className="btn-close"
                data-bs-dismiss="modal"
            ...
            <div className="modal-body">
              <div className="row mx-auto">
                <div className="col col-md-6 col-lg-6">
                  <img
                    src="https://i.ibb.co/QQT619D/virtual-Cv1.png"
                    className="w-100 mb-4 rounded"
                    alt="Landing"
                  />
                  <img
                    src="https://i.ibb.co/TTfDdtn/virtual-Cv2.pngg"
                    className="w-100 mb-4 rounded"
                    alt="Tech"
                  />
                </div>
                <div className="col col-md-6 col-lg-6">
                  <img
                    src="https://i.ibb.co/3YHp3RV/virtual-Cv3.png"
                    className="w-100 mb-4 rounded"
                    alt="Cards"
                  />
                  <img
                    src="https://i.ibb.co/h9dYBBM/virtual-Cv4.png"
                    className="w-100 mb-4 rounded"
                    alt="Formation"
                  />
                </div>
